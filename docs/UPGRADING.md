...
- **Candidate window theme backup.** An unreadable [`CaretTheme`](CONFIGURATION.md#candidate-window-theming-carettheme) backup is kept as `...backup.conf.broken` instead of being deleted.

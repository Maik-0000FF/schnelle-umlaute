...
## ⚠️ Upgrading from v0.x to v1.0.0
...
**Recommended upgrade path:** Run `./uninstall.sh` first (choose "y" to remove user configuration), then `./install.sh`. Your mappings will be reset to defaults — reconfigure them via `fcitx5-config-qt` or edit `mappings.txt` manually.
